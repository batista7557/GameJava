...
public class Entity {
	...
	/**
	 * Método com informações básicas sobre as entities (objetos que interagem com o jogador)
	 * @param x
	 * @param y
	 * @param width
	 * @param height
	...
	/**
	 * Método que seta uma máscara em cada entitie
	 * @param maskx
	 * @param masky
	 * @param mwidth
	 * @param mheight
	...
	/**
	 * Método que checa colisão entre entities
	 * @param e1
	 * @param e2
	 * @return
	 */
